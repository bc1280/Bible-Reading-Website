...
<div class="w3-main" style="margin-left:300px">
    ...
    <div class="w3-row">
        ...
        <div class="w3-col" style="width:80%"><p>
            <h4 class="w3-text-teal"><b>2 John</b></h4>
            <ol>
                <li>In 2 John 7, what does John call those who deny that Jesus is God Who came in the flesh?</li>

                <li>In verse 10, should we welcome anyone who does not bring the right teaching?</li>
