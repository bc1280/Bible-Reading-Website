...
<div class="w3-main" style="margin-left:300px">
    ...
    <div class="w3-row">
        ...
        <div class="w3-col" style="width:80%"><p>
            <h4 class="w3-text-teal"><b>Philemon</b></h4>
            <ol>
                <li>In this short book, who are the three characters: Paul, Onesimus and Philemon?</li>

                <li>What does this book show us about the status of the believers in the New Man?</li>
